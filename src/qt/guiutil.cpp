...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "BTCP.lnk";
}
...
{
    return GetAutostartDir() / "BTCP.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("BTCP-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  BTCP-qt [" + tr("command-line options") + "]                     " + "\n";
