                              ...
                              size_t request_len)
{
  ...
  base16_encode(hearopa,9,(char*)request,4);

  log_info(LD_REND,
           "Established rendezvous point on circuit %u for cookie %s",
           (unsigned)circ->p_circ_id, hearopa);
                    ...
                    size_t request_len)
{
  ...
  base16_encode(hearopa, sizeof(hearopa), (const char*)request, 4);
  ...
  log_info(LD_REND,
           ...
           (unsigned)circ->p_circ_id, (unsigned)rend_circ->p_circ_id, hearopa);
