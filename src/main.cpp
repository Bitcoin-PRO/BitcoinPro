...
unsigned int nStakeTargetSpacing = 60;			// 120 sec block spacing

int64 nChainStartTime = 1511966103;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if (nHeight == 1)
        nSubsidy = 1000000 * COIN; // genesis block coinbase is unspendable
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BitcoinPro
    bool fStrictPayToScriptHash = true; // Always active in BitcoinPro
...
if (!CheckCoinStakeTimestamp(GetBlockTime(), (int64)vtx[1].nTime))
    ...
    if ((nTime >= CUTOFF_POW_TIME) && (IsProofOfWork()))
         return DoS(100, error("CheckBlock() : Proof of work (%f BitcoinPro) at t=%d on or after %d.\n",
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "20170112 BitcoinPro proves that pzTimestamp is overkill.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1511966103;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 209324; // perfect nonce
        ...
        assert(block.hashMerkleRoot == uint256("0x6cc9ff3e4355d60586320ec30b61ea4505c51cccd94c8ef35b50c71427dd39f3"));
